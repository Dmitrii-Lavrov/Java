...
public class Game {
    ...
    private static Participant[] createParticipants() {
        return new Participant[] {
                new Cat("Cat-1", 10, 2,2),
                new Cat("Cat-2", 8, 5, 3),
                new Human("Human-1", 8, 5, 3, 2),
                new Cheater("Cheater")
        };
    }
    ...
    private static Obstacle[] createObstacles() {
        return new Obstacle[] {
                new RoadObstacleAdapter (new Road("Road", 9)),
                new SwimmingPoolObstacleAdapter(new SwimmingPool("SwimmingPool", 4)),                   
                new WallObstacleAdapter(new Wall("Wall", 4)),
                new DitchObstacleAdapter(new Ditch("Ditch", 1))
        };
    }
